...
public class LoginController {
    ...
    //账号登陆
    @PostMapping("/login")
    public String login(@CookieValue(value = "kaptchaOwner",required = false) String kaptchaOwner,Model model,String username,String password,String code,boolean rememberme,HttpServletResponse response){
        //检查验证码
